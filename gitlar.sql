...
CREATE TABLE `gl_page` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='前段页面表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-20  2:00:01
